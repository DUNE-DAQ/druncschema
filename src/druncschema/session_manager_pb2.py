...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_LOADSESSIONRESPONSE']._serialized_end=904
  _globals['_SESSIONMANAGER']._serialized_start=907
  _globals['_SESSIONMANAGER']._serialized_end=1348
