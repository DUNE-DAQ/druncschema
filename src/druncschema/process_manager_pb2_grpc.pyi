...
class ProcessManagerStub:
    ...
    restart: _grpc.UnaryUnaryMultiCallable[_process_manager_pb2.ProcessQuery, _process_manager_pb2.ProcessInstanceList]
    kill: _grpc.UnaryUnaryMultiCallable[_process_manager_pb2.ProcessQuery, _process_manager_pb2.ProcessInstanceList]
...
class ProcessManagerAsyncStub(ProcessManagerStub):
    ...
    restart: _aio.UnaryUnaryMultiCallable[_process_manager_pb2.ProcessQuery, _process_manager_pb2.ProcessInstanceList]  # type: ignore[assignment]
    kill: _aio.UnaryUnaryMultiCallable[_process_manager_pb2.ProcessQuery, _process_manager_pb2.ProcessInstanceList]  # type: ignore[assignment]
...
class ProcessManagerServicer(metaclass=_abc_1.ABCMeta):
    ...
    def boot(
        ...
        context: _ServicerContext,
    ) -> _typing.Union[_process_manager_pb2.ProcessInstanceList, _abc.Awaitable[_process_manager_pb2.ProcessInstanceList]]: ...
